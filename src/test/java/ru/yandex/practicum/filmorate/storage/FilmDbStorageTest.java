...
class FilmDbStorageTest {
    ...
    @Test
    void findAll() {
        film = new Film(1, "test", LocalDate.of(2010, 2, 2), "testing",
                100, 4, new Mpa(5, "NC-17"), null);
        filmDbStorage.create(film);
        film = new Film(2, "test", LocalDate.of(2010, 2, 2), "testing",
                100, 4, new Mpa(5, "NC-17"), null);
        filmDbStorage.create(film);
        film = new Film(3, "test", LocalDate.of(2010, 2, 2), "testing",
                100, 4, new Mpa(5, "NC-17"), null);
        filmDbStorage.create(film);

        Collection<Film> filmCollection = filmDbStorage.findAll();

        assertEquals(filmCollection.size(), 4, "неправельное количество фильмов");
    ...
    void update() {
        film = new Film(1, "test", LocalDate.of(2010, 2, 2), "testing",
                100, 4, new Mpa(5, "NC-17"), null);
        filmDbStorage.create(film);
        film = new Film(1, "testllll", LocalDate.of(2010, 2, 2), "testing",
                100, 4, new Mpa(5, "NC-17"), null);
    ...
    void putLikeFilmById() {
        ...
        filmDbStorage.putLikeFilmById(1, 1);
